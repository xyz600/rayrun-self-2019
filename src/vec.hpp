...
template <typename T, std::size_t D>
const T& Point<T, D>::x() const noexcept {
  return data_[0];
}

template <typename T, std::size_t D>
T& Point<T, D>::x() noexcept {
  return data_[0];
}

template <typename T, std::size_t D>
const T& Point<T, D>::y() const noexcept {
  return data_[1];
}

template <typename T, std::size_t D>
T& Point<T, D>::y() noexcept {
  return data_[1];
}

template <typename T, std::size_t D>
const T& Point<T, D>::z() const noexcept {
  return data_[2];
}

template <typename T, std::size_t D>
T& Point<T, D>::z() noexcept {
  return data_[2];
}
...
template <typename PointType>
ExpressionDividesValue<PointType> operator/(
    const PointType& point, const typename PointType::value_type value) {
